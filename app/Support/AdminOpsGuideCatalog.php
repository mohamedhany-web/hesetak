    ...
    public static function sections(): array
    {
        return [
            ...
            [
                ...
                'summary' => 'مسار اعتماد المعلم: نموذج التقديم → مراجعة → تفعيل حساب.',
                'audience' => 'فريق توظيف · مشرف أكاديمي',
                'decision' => 'لا يُفعَّل معلم قبل اكتمال المراجعة والمطابقة (مرحلة+مادة+منهج).',
                'steps' => [
                    'راجع الطلبات الجديدة في لوحة التوظيف.',
                    'افحص النموذج والمستندات.',
                    'فعّل الحساب بعد الاعتماد وحدّث ملف المطابقة.',
                ],
