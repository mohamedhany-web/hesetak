                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="product_track" class="w-full rounded-xl border border-line bg-surface px-4 py-3 text-ink">
                                        <option value="" @selected(old('product_track', '') === '')>مباشر / افتراضي</option>
                                        <option value="recorded" @selected(old('product_track') === 'recorded')>كورس مسجّل (فيديو/شرح)</option>
                                        <option value="book" @selected(old('product_track') === 'book')>كتاب للقراءة على الموقع (upsell)</option>
                                    </select>
