...
class LiveKitRoomProviderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config([
            ...
            'livekit.livekit.url' => 'wss://live.hissatak.online',
            'livekit.livekit.host' => 'live.hissatak.online',
        ]);
    }
    ...
    public function test_student_room_uses_student_theme_and_share_tools(): void
    {
        ...
        $session = LiveSession::create([
            ...
            'server_id' => $server->id,
            'title' => 'جلسة طالب',
            'room_name' => 'hesetak-student-theme',
            'status' => 'live',
            'started_at' => now(),
            'require_enrollment' => false,
    ...
    public function test_live_meeting_tokens_never_allow_data_publish(): void
    {
        ...
        $session = LiveSession::create([
            ...
            'room_name' => 'hesetak-chat-blocked',
            'status' => 'live',
            'started_at' => now(),
            'require_enrollment' => false,
            'allow_chat' => true,
